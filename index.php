            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single_recepie text-center">
                        ...
                        <a href="Egg_Manchurian.php" class="line_btn">View Full Recipe</a>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single_recepie text-center">
                        ...
                        <span>Appetizer</span>
                        <p>Time Needs: 30 Mins</p>
                        <a href="Pure_vegetable_bow.php" class="line_btn">View Full Recipe</a>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single_recepie text-center">
                        ...
                        <span>Appetizer</span>
                        <p>Time Needs: 30 Mins</p>
                        <a href="Egg_Masala_Ramen.php" class="line_btn">View Full Recipe</a>
                    </div>
                </div>
            </div>
        </div>
